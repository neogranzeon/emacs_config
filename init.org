#+TITLE: My Emacs Configuration Files (Orgmode)
#+AUTHOR: neogranzeon
#+BABEL: :cache yes
...
* About
  ...
  This is an Emacs configuration file written in [[http://orgmode.org][Org mode]]. This configuration
  based on the [[https://github.com/larstvei/dot-emacs#lisp][larstvei emacs init version]] plus some of my own configuration.
  Some of the following tools are removed from the original packages:
    - git-gutter-fringe (Make some error in my Mac)
    - mu4e (Don't need this packages yet)
...
** Sane defaults
   ...
   Automatically full-screen when staring emacs
#+BEGIN_SRC emacs-lisp
...
#+END_SRC
** Image Support
In order to enable PNG Support, doc-view need to know where is the GhostScript
It is usually located in $/usr/local/bin/$

#+BEGIN_SRC emacs-lisp
(setq doc-view-ghostscript-program "/usr/local/bin/gs")
#+END_SRC

To support display image in emacs
#+BEGIN_SRC emacs-lisp
...
** LaTeX and org-mode LaTeX export
   ...
   Add texbin path into emacs PATH 
